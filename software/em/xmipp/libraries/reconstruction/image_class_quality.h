...
#ifndef CLASS_QUIALITY_H
#define CLASS_QUIALITY_H
...
//@{
class ProgClassQuality: public XmippProgram
{
public:
	 /** Filenames */
	FileName fnOut, fnImg, fnMask, fnMd;
...
public:
    ...
    void amplitudeMonogenicSignal(MultidimArray< std::complex<double> > &myfftV,
